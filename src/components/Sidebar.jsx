  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-10 w-64 bg-white border-r flex flex-col">
      ...
      <nav className="flex-1 px-4 space-y-2">
        <Link to="/dashboard" className="block px-4 py-2 rounded hover:bg-muted">Overview</Link>
        ...
        <Link to="/employees" className="block px-4 py-2 rounded hover:bg-muted">Employees</Link>
      </nav>
