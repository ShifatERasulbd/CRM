...
export default function CustomersForm({ onSuccess, initialData = null, isEdit = false }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 bg-white p-6 rounded-lg shadow max-w-xl mx-auto">
      <h2 className="text-lg font-semibold mb-2">{isEdit ? "Edit Customer" : "Add Customer"}</h2>
      {error && (
